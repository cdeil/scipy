Differentiation (:mod:`scipy.diff`)
===================================

.. currentmodule:: scipy.diff

The :mod:`scipy.diff` sub-package provides several differentiation techniques.

At the moment it contains a modified version of numdifftools. 
...
Compute 1'st and 2'nd derivative of exp(x), at x == 1::
    ...
    >>> import numpy as np
    >>> from scipy.diff import Derivative, Jacobian, Gradient
